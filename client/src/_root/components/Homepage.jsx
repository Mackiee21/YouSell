...
function Homepage() {
  ...
  return (
    <main className="flex flex-col gap-7 lg:gap-10">
      ...
      <section className={`grid grid-cols-4 lg:grid-cols-5 gap-2.5 md:gap-7 transition-all duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100' }`}>
