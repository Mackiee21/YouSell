  ...
  return (
        <div className="auth-form-container">
          ...
          <div className="w-full grid grid-cols-1 items-center justify-center rounded border border-teal-900 md:px-0">
            <div className={`w-full bg-red-700 tracking-wide text-white text-sm font-medium text-center rounded-b-sm py-3.5 ${!incorrectCredentials && 'hidden'}`}>{errorMessage}</div>
